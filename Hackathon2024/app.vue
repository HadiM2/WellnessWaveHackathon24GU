<template>
  <NuxtLayout>
    ...
    <v-app  class="animated-background">
      ...
      <v-navigation-drawer color="transparent" v-model="menu" location="right">
        <v-list>
...
.custom-app-bar {
  ...
  border-bottom: 2px solid transparent; /* Sharp accent line */
}
.custom-nav-button {
